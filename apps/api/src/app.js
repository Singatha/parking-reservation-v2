...
app.use("/api/v1/vehicles", authenticate, vehicleRouter);
app.use("/api/v1/spaces", authenticate, spaceRouter);
app.use("/api/v1/reservations", authenticate, reservationRouter);
